        ...
        <section class="sidebar">
            ...
            <ul class="sidebar-menu" data-widget="tree">
                ...
                <li class="treeview">
                    ...
                    <ul class="treeview-menu">
                        <li class="active"><a href="/admin/posts/"><i class="fa fa-circle-o"></i> 文章列表</a></li>
                        <li><a href="/admin/posts/create"><i class="fa fa-circle-o"></i> 发布文章</a></li>
                ...
                <li class="treeview">
                    <a href="#">
                        <i class="fa fa-th"></i> <span>专题管理</span>
                        <span class="pull-right-container">
                          <i class="fa fa-angle-left pull-right"></i>
                        </span>
                    </a>
                ...
                <li class="treeview">
                    <a href="#">
                        <i class="fa fa-bell-o"></i> <span>通知管理</span>
                        <span class="pull-right-container">
                          <i class="fa fa-angle-left pull-right"></i>
                        </span>
                    </a>
